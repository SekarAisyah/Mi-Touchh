...
Route::get('/dashboard/pelatihan', [DashboardController::class, 'countPelatihan'])->name('dashboard.countpelatihan');
...
Route::post('/pelatihan/get_kompetensi', [PelatihanController::class, 'getKompetensi']);
...
Route::post('/coaching/exporttoword', [CoachingController::class, 'exportToWord'])->name('export.coaching');
...
Route::post('/coaching/get_kompetensi', [CoachingController::class, 'getKompetensi']);
...
Route::post('/admp/exporttoword', [AdmpController::class, 'exportToWord'])->name('export.admp');
...
Route::post('/admp/get_kompetensi', [AdmpController::class, 'getKompetensi']);
