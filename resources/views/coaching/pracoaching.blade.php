    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Pra-coaching</li>
        </ol>
      </nav>
    </div>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><i class="fa-solid fa-square-poll-vertical"></i> Pra-coaching</h5>
              <button type="button" class="btn bi bi-plus btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#pracoachingModal"> Add Pra coaching</button>
              <br><br>

              <!-- Modal View -->
                <div class="modal fade modal-view" id="viewPracoachingModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <!-- Modal Add -->
                <div class="modal fade modal_add" id="pracoachingModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-mode="add">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="btn-add">Add Pra coaching</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        ...
                        <form class="row g-3 needs-validation" method="POST" action="/pracoaching/create"  enctype="multipart/form-data">
                        @csrf
                            <div class="col-12">
                            <div class="form-floating">
                                 <h6 class="labelku">Identitas Peserta</h6>
              ...
              <!-- Modal Edit -->
                <div class="modal fade modal_edit" id="editpracoachingModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-mode="edit">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="btn-add">Edit Pra coaching</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form class="row g-3 needs-validation" id="formedit" action="/pracoaching/myedit/{id}"  enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                            <div class="col-12">
                            <div class="form-floating">
                            ...
                            <div class="col-md-12">
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Address" id="ringkasan_coaching_edit" name="ringkasan_coaching_edit" style="height: 200px;"></textarea>
                                <label for="message-text">Ringkasan hasil coaching </span></label>
                            </div>
                            </div>
                            <div class="col-md-12">
              ...
              <table class="table dt_coaching" id="datatable">
                ...
                <tr>
                    ...
                    <td>{{ $pracoaching->divisi}}</td>
                    <td class="truncate-text">{{ $pracoaching->ringkasan }}</td>
                     <td>
                        <a class="btn bi bi-file-earmark-text-fill text-primary" href="{{ asset($pracoaching->file_path) }}" target="_blank">
                        </a>
                    </td>
                    <td>  
                        <div class="dropdown">
                        ...
                        <ul class="dropdown-menu"> 
                            <li><a class="dropdown-item view" href="#" data-bs-toggle="modal" data-bs-target="#viewPracoachingModal" data-id="{{ $pracoaching->id }}"><i class="fa fa-expand"></i>View</a></li> 
                            <li><a class="dropdown-item edit" href="#" data-bs-toggle="modal" data-bs-target="#editpracoachingModal" data-id="{{ $pracoaching->id }}"><i class="fa-regular fa-pen-to-square"></i>Edit</a></li>
                            <li><a class="dropdown-item delete" href="#" data-id="{{ $pracoaching->id }}"><i class="fa-solid fa-trash"></i>Delete</a></li>        
                        </ul>
                        </div>
                    </td>
                </tr>
...
$('.view').click(function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#viewPracoachingModal').find('#divisi').text(response.divisi);
            ...
            $('#viewPracoachingModal').find('#file').html('<a href="' + response.file_path + '" target="_blank" class="btn bi bi-file-earmark-text-fill text-primary"></a>');
...
$('.edit').click(function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#editpracoachingModal').find('#nrp-dropdown-edit').val(response.nrp);
            $('#editpracoachingModal').find('#name-edit').val(response.name);
            $('#editpracoachingModal').find('#jabatan-edit').val(response.jabatan);
            $('#editpracoachingModal').find('#departemen-edit').val(response.departemen);
            $('#editpracoachingModal').find('#divisi-edit').val(response.divisi);
            $('#editpracoachingModal').find('#distrik-edit').val(response.distrik);
