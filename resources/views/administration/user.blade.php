            ...
            <div class="card-body">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        ...
                        @csrf
                            ...
                            <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text"class="form-control" id="distrik" name="distrik" placeholder="divisi">
              ...
              <table class="table dt_user" id="datatable">
                ...
                <tr>
                    ...
                    <td>{{ $user->nrp }}</td>
                    <td>{{ $user->name }}</td>
                    <td class='truncate-text'>{{ $user->email }}</td>
...
$('.view').click(function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#viewuserModal').find('#distrik-view').text(response.distrik);
...
$('.edit').click(function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#userModal #distrik').val(response.distrik);
