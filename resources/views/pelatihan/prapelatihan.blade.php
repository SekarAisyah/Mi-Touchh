    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Pra-Pelatihan</li>
        </ol>
      </nav>
    </div>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><i class="fa-solid fa-square-poll-vertical"></i> Pra-Pelatihan</h5>
              <button type="button" class="btn bi bi-plus btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#prapelatihanModal"> Add Pra Pelatihan</button>
              <br><br>

              <!-- Modal View -->
                <div class="modal fade modal-view" id="viewPraPelatihanModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <!-- Modal Add -->
                <div class="modal fade modal_add" id="prapelatihanModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-mode="add">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="btn-add">Add Pra Pelatihan</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        ...
                        <form class="row g-3 needs-validation" method="POST" action="/prapelatihan/create"  enctype="multipart/form-data">
                        @csrf
                            <div class="col-12">
                            <div class="form-floating">
                                 <h6 class="labelku">Identitas Peserta</h6>
              ...
              <!-- Modal Edit -->
                <div class="modal fade modal_edit" id="editprapelatihanModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-mode="edit">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="btn-add">Edit Pra Pelatihan</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form class="row g-3 needs-validation" id="formedit" action="/prapelatihan/myedit/{id}"  enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                            <div class="col-12">
                            <div class="form-floating">
                            ...
                            <div class="col-md-4">
                             ...
                             <div class="col-md-4">
                             <div class="form-floating">
                                <input type="text" readonly class="form-control" id="divisi-edit" name="divisi-edit" placeholder="Password">
                                <label for="message-text">Divisi</label>
                            </div>
                            </div>
                            <div class="col-md-4">
                             <div class="form-floating">
                                <input type="text" readonly class="form-control" id="distrik-edit" name="distrik-edit" placeholder="Password">
                                <label for="message-text">Distrik</label>
                            </div>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-md-12">
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Address" id="ringkasan_pelatihan_edit" name="ringkasan_pelatihan_edit" style="height: 200px;"></textarea>
                                <label for="message-text">Ringkasan hasil Pelatihan </span></label>
                            </div>
                            </div>
                            <div class="col-md-12">
              ...
              <table class="table dt_pelatihan" id="datatable">
                ...
                <tr>
                    ...
                    <td>{{ $prapelatihan->divisi}}</td>
                    <td class="truncate-text">{{ $prapelatihan->ringkasan }}</td>
                     <td>
                        <a class="btn bi bi-file-earmark-text-fill text-primary" href="{{ asset($prapelatihan->file_path) }}" target="_blank">
                        </a>
                    </td>
                    <td>  
                        <div class="dropdown">
                        ...
                        <ul class="dropdown-menu"> 
                            <li><a class="dropdown-item view" href="#" data-bs-toggle="modal" data-bs-target="#viewPraPelatihanModal" data-id="{{ $prapelatihan->id }}"><i class="fa fa-expand"></i>View</a></li> 
                            <li><a class="dropdown-item edit" href="#" data-bs-toggle="modal" data-bs-target="#editprapelatihanModal" data-id="{{ $prapelatihan->id }}"><i class="fa-regular fa-pen-to-square"></i>Edit</a></li>
                            <li><a class="dropdown-item delete" href="#" data-id="{{ $prapelatihan->id }}"><i class="fa-solid fa-trash"></i>Delete</a></li>        
                        </ul>
                        </div>
                    </td>
                </tr>
...
$('.view').click(function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#viewPraPelatihanModal').find('#divisi').text(response.divisi);
            ...
            $('#viewPraPelatihanModal').find('#file').html('<a href="' + response.file_path + '" target="_blank" class="btn bi bi-file-earmark-text-fill text-primary"></a>');
    ...
    $('#nrp-dropdown-edit').on('change', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#distrik-edit').val(response.distrik);
            },
            error: function(error) {
                console.log('Ajax Error:', error);
            }
...
$('.edit').click(function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#editprapelatihanModal').find('#nrp-dropdown-edit').val(response.nrp);
            ...
            $('#editprapelatihanModal').find('#divisi-edit').val(response.divisi);
            $('#editprapelatihanModal').find('#distrik-edit').val(response.distrik);
            $('#editprapelatihanModal').find('#ringkasan_pelatihan_edit').val(response.ringkasan);
            $('#editprapelatihanModal').find('#efektivitas_pelatihan_edit').val(response.efektivitas);
