    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3 me-3">
          ...
          @if (auth()->check())
              <span class="d-none d-md-block dropdown-toggle ps-2">{{ auth()->user()->name }} | {{ auth()->user()->jabatan }} </span>
          @endif
          </a>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#forms-pel" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i><span>Pelatihan</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-pel" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="/prapelatihan">
              <i class="bi bi-circle"></i><span>Pra Pelatihan</span>
            </a>
          </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#forms-admp" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>ADMP: Job Assignment</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-admp" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="/praadmp">
              <i class="bi bi-circle"></i><span>Pra ADMP</span>
            </a>
          </li>
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#forms-coaching" data-bs-toggle="collapse" href="#">
          <i class="bi bi-gem"></i><span>Coaching</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-coaching" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="/pracoaching">
              <i class="bi bi-circle"></i><span>Pra Coaching</span>
            </a>
          </li>
